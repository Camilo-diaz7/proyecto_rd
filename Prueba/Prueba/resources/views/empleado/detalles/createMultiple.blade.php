...
<div class="container">
    ...
    <form action="{{ route('empleado.detalles.storeMultiple') }}" method="POST" id="multipleProductsForm">
        @csrf
        ...
        <div class="mt-3">
            ...
            <a href="{{ route('empleado.detalles.porVenta', ['venta' => $venta_id]) }}" class="btn btn-secondary">
